...
(function($) {
	...
	$pc.fn.extend({
		...
		build: function() {
			...
			this.imgPrev	= $("<a class='previous'>上一页</a>").insertAfter(this.imgPlay);
			this.imgNext	= $("<a class='next'>下一页</a>").insertAfter(this.imgPrev);
		...
		*/
		finishAnimating: function(data){
			...
			if(this.options.showCaption && data.caption !== "" && data.caption !== null){
				this.caption.html(data.caption).fadeTo('slow',0);
			}
